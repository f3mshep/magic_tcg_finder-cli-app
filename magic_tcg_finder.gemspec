...
Gem::Specification.new do |spec|
  ...
  spec.files = ["lib/magic_tcg_finder.rb","config/environment.rb","lib/magic_tcg_finder/command_line_interface.rb", "lib/magic_tcg_finder/card.rb","lib/magic_tcg_finder/scraper.rb" ]
